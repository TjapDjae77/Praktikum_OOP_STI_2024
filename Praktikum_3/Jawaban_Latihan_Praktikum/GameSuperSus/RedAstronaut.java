...
public class RedAstronaut extends Player implements Impostor{
    ...
    public RedAstronaut(String name) {
        ...
        this(name, Player.DEFAULT_SUS_LEVEL, DEFAULT_SKILL);
    }
    ...
    public void emergencyMeeting() {
        if(!this.isFrozen()){
            ...
            for (Player p : players){
                if((p != this) && (!p.isFrozen()) && (p.getSusLevel() >= maxSusLevel)){
    ...
    */
    public boolean equals(Object o) {
        if (o instanceof RedAstronaut) {
            ...
            return this.getName().equals(redplayer.getName()) && this.isFrozen() == redplayer.isFrozen()
                    && this.getSusLevel() == redplayer.getSusLevel() && this.skill.equals(redplayer.skill);
        }
        return false;
    }
